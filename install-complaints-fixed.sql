...
-- ÉTAPE 6: Créer les politiques RLS CORRIGÉES
-- ========================================
...
DROP POLICY IF EXISTS "Restaurants can view complaints for their orders" ON complaints;
...
-- Politique corrigée pour les restaurants
...
DROP POLICY IF EXISTS "Restaurants can view feedback for their orders" ON order_feedback;
