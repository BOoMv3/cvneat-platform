-- Verrou anti-flip: seules les actions explicites owner/admin peuvent changer
-- ferme_manuellement / ouvert_manuellement.
-- Ne dépend PAS de request.jwt.claim.sub (inconstant selon environnements).
...
-- Toujours actif, même en mode replica
