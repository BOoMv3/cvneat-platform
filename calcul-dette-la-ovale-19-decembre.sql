-- Script pour calculer ce qui était dû au restaurant La Ovale le 19 décembre 2024
-- Exclut toutes les transactions après le 19 décembre

-- 1. Trouver le restaurant La Ovale
SELECT id, nom FROM restaurants 
WHERE nom ILIKE '%ovale%' OR nom ILIKE '%oval%';
