-- Créer des commandes de test en production (avec les vrais UUIDs)
-- Exécuter ce script dans Supabase (onglet SQL Editor)

-- Commande #6001 - Alerte préventive (15 min de préparation)
INSERT INTO orders (
  id, customer_name, customer_phone, restaurant_id, total_amount, delivery_fee, 
  status, delivery_id, preparation_time, items, created_at, updated_at, 
  security_code
) VALUES (
  6001, 
