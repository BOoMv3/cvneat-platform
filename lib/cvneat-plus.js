...
export const CVNEAT_PLUS_MIN_ORDER_EUR = 15;
...
export const CVNEAT_PLUS_PITCH = {
  ...
  yearlyEur: 49.99,
  competitorLabel:
    "Sur les grandes apps, l’abonnement type « One » comprend souvent la livraison 0 € sur des conditions précises. En local, l’abonnement ne suffit pas à rembourser toute la course : on applique plutôt une remise sur les frais pour rester durable.",
  benefits: [
    ...
    'Le reste des frais alimente la course et le livreur : l’abonnement complète, il ne remplace pas tout le coût',
  ],
};
