    ...
    html: `
      ...
      <body>
        ...
        <div class="content">
          ...
          <p class="muted"><strong>Conseil :</strong> ouvrez le lien une seule fois dans Safari ou Chrome (évitez la prévisualisation dans l’app mail). Sur la page, saisissez votre nouveau mot de passe puis validez.</p>
          <p class="muted">Lien valable environ 1 heure. Si le bouton ne fonctionne pas, copiez l’adresse ci-dessous dans votre navigateur :</p>
