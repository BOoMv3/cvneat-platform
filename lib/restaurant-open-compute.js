...
export function computeRestaurantOpenState({ id = null, horaires, ferme_manuellement, ouvert_manuellement, now = new Date() }) {
  ...
  // ouvert_manuellement avant ferme_manuellement : évite un couple fm=true resté en base
  // alors que le partenaire a « ouvert » (souvent seul ferme_manuellement=false est PATCH).
