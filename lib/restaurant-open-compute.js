...
export function computeRestaurantOpenState({
  ...
  /* isManuallyClosed reste false côté public : le rouge « fermé manuellement »
   * confondait tout le monde ; fermeture partenaire = fermé (isOpen false) seulement. */
  if (coerceManualBool(ferme_manuellement)) {
    return { isOpen: false, isManuallyClosed: false, reason: 'manual_closed', meta: {} };
  }
