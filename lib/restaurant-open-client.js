...
/**
 * Accueil / tri : la source de vérité est toujours l’objet `restaurant` (flags issus de /api/restaurants
 * avec normalizeRestaurantOpenFields). Ne plus préférer `restaurantsOpenStatus` : pour certains IDs
 * (UUID vs string, rafraîchis partiels) la map pouvait rester « ouvert » alors que la fiche détail
 * lisait encore les vrais flags → liste ≠ page restaurant.
 */
