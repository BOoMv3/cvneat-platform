...
/** True si le jour a des plages ou une paire ouverture/fermeture exploitable. */
export function hasExplicitScheduleForDay(horairesRaw, refDate = new Date()) {
  ...
  const hasSingle = Boolean((day.ouverture || day.debut) && (day.fermeture || day.fin));
  return hasPlages || hasSingle;
}
