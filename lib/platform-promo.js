...
export const LA_BONNE_PATE_STOCK_PROMO_ACTIVE = true;
...
/**
 * Réduction « plateforme » au checkout : promo globale 2e article OU promo pizzas La Bonne Pâte
 * (jamais cumulées : si La Bonne Pâte, uniquement la promo pizzas).
 */
