...
-- 1. Mettre à jour l'utilisateur admin2@cvneat.com pour qu'il soit associé au bon restaurant
UPDATE restaurants 
...
-- 3. Vérifier que la commande #999 est maintenant visible pour cet utilisateur
SELECT 
